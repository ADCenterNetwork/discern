...
class AncestorInfo():
    ...
    def createFolderForLabels(self):
        ...
        path = "LabelFolder_ancestor_" + nameproject
    ...
    def nodeAttributeCreator_anc(self, filepath, node, contador, padre=None):
    ...
    def dictionaryCreator_anc(self, node, padre):
            self.dict_with_gen[self.contador] = {"class_name": self.node_classification[node.__class__.__name__], "anc1_class_name": self.node_classification[self.parents[node].__class__.__name__], "anc2_class_name": self.node_classification[self.parents[self.parents[node]].__class__.__name__], "anc3_class_name": self.node_classification[self.parents[self.parents[self.parents[node]]].__class__.__name__], "anc4_class_name": self.node_classification[self.parents[self.parents[self.parents[self.parents[node]]]].__class__.__name__], "Generator": 0}
    ...
    def labelFileCreator_anc(self, nameproject, folders_path_tuple):
        field_names = [["class_name", "anc1_class_name", "anc2_class_name", "anc3_class_name", "anc4_class_name", "Generator"], ["class_name", "anc1_class_name", "anc2_class_name", "anc3_class_name", "anc4_class_name"]]
