...
class GeneratorPatternFinder(AbstractPatternFinder):
    ...
    def ___assignfind(self,new_variable, node, ls, i):
        ...
        for child in ast.iter_child_nodes(node):
            ...
            self.___assignfind(new_variable, child, ls, i)
        #else:
        #    self.assigns[GeneratorFinderUtils.get_name(new_variable)] = self.temporalassign[GeneratorFinderUtils.get_name(new_variable)]
    ...
    def _mapeo(self):
        ...
        #with io.open('sourcemap2.json','w') as f:
